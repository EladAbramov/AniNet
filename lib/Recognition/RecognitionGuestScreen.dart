...
class RecognitionGuestScreen extends StatefulWidget {
  RecognitionGuestScreen({Key key}) : super(key: key);
  _RecognitionGuestScreenState createState() => _RecognitionGuestScreenState();
}

class _RecognitionGuestScreenState extends State<RecognitionGuestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('AniNet Guest', style: TextStyle(color: Colors.black),),
      ),
      body: !live ? Center(
        child: ListView(
          children: <Widget>[
