...
class _EditAnimalState extends State<EditAnimal> {
  ...
  editAnimal(String _id, String animalAvatarUrl, String animalName, String animalType, String animalAge , String animalVideoUrl, String ownerEmail) async {
    var url = "http://10.0.2.2:5000/animals/$_id";
    print(_id + ' ' + animalAvatarUrl + ' ' + animalName + ' ' + animalType + ' ' + animalAge + ' ' + animalVideoUrl + ' ' + ownerEmail);
    http.put(url,
        body: {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Animal Profile", style: TextStyle(color: Colors.black),), iconTheme: IconThemeData(color: Colors.black),),
      body: Container(
      ...
      child: ConstrainedBox(
        ...
        child: RaisedButton.icon(
          ...
          onPressed: () async {
            ...
            var _animalId = prefs.getString("newAnimalId");
            animalId = _animalId;
            print(animalId);
            editAnimal(animalId, animalAvatarUrl, animalName, animalAge, animalType, animalVideoUrl, ownerEmail);
            if(token!=null){
              _saveForm();
